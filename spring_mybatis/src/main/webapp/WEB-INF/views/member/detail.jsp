				...
				<div class="card-footer" style="padding: 5px 0;">
					<div class="row">
						<div class="col-sm-3 text-center">
							<button type="button" onclick="location.href='modifyForm?id=${member.id}';" id="modifyBtn"
								class="btn btn-warning ">수 정</button>
						</div>

						<div class="col-sm-3 text-center">
							<button type="button" onclick="location.href='remove?id=${member.id}';" id="deleteBtn"
